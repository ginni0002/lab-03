...
fun CityListScreen(
    ...
    var newCityName by remember { mutableStateOf<String>("") }
    var newProvinceName by remember { mutableStateOf<String>("") }
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        if (cityToUpdate != null) {
            var updatedCityName by remember(cityToUpdate) { mutableStateOf(cityToUpdate.name) }
            var updatedProvinceName by remember(cityToUpdate) { mutableStateOf(cityToUpdate.province) }
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(16.dp)
